...
class Utils ():
    ...
    def recursive_feature_elimination_wrapper(self, estimator, feature_numbers, X,Y):
        return recursive_feature_elimination_wrapper(estimator, feature_numbers, X,Y)
